...
export function ApplicationBar({ mode, toggleColorMode, children }: ApplicationBarProps) {
          ...
          <Toolbar
            ...
            <Box
              ...
              <Stack direction="row" alignItems="center" gap={0.5}>
                ...
                <Typography variant="h6" sx={theme => ({ fontFamily: "Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif", color: theme.palette.primary.main })}>
                  Tibia Stalker
                </Typography>
              </Stack>
